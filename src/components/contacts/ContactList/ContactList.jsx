            ...
            <div className="row">
              <div className="col">
                <p className="h3 fw-bold">Contact Manager
                  ...
                  <i className='fa fa-plus-circle me-1'/>New</Link>
                </p>
                <p className='fst-italic'>Here you can manage your contact list by adding, viewing, updating and deleting the information of your contacts.</p>
              </div>
            </div>
            <div className="row">
              <div className="col-md-6">
                <form className='row'>
                  <div className="col">
                    <div className="mb-2">
                      <input type="text" name='text' value={query.text} onChange={searchContacts} className='form-control' placeholder='Search Names'/>
                    </div>
                  </div>
                  <div className="col">
                    <div className="mb-2">
                      <input type="text" className='btn btn-outline-dark' defaultValue={'Search'}/>
                    </div>
                  </div>
                </form>
              </div>
